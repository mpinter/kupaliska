...
export const Qr = ({ id }): JSX.Element => {
  ...
  return (
    <div className="container">
      <main>
        <h1 className="title">Platba</h1>

        <p className="description">
          Tu ma byt integracia s branou - zatial sa v tomto kroku listok
          automaticky 'zaplati'.
        </p>
        <button onClick={payAndNavigate}>
          {loading ? 'Pockajte prosim' : 'Zaplatit'}
        </button>
      </main>
